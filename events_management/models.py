...
class Event(models.Model):
    """Event management - created and managed by staff"""
    ...
    # Management
    created_by = models.ForeignKey(User, on_delete=models.CASCADE, related_name='managed_events')
    ...
    def is_registration_open(self):
        ...
        return (self.status == 'published' and 
                ...
                (not self.max_participants or self.registrations.count() < self.max_participants))
...
class EventRegistration(models.Model):
    ...
    payment_verified_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='verified_event_payments')
