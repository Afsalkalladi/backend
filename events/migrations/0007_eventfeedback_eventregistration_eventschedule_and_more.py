# Generated by Django 5.1.4 on 2025-07-14 20:44
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('events', '0006_delete_eventregistration'),
    ...
    operations = [
        ...
        migrations.RemoveIndex(
            model_name='event',
            name='events_even_start_d_06f960_idx',
        ),
        migrations.AddField(
            model_name='event',
            name='address',
        ...
        migrations.AddField(
            model_name='event',
            name='event_flyer',
            field=models.FileField(blank=True, null=True, upload_to='event_flyers/'),
        ),
        migrations.AddField(
            model_name='event',
            name='is_online',
        ...
        migrations.AddField(
            model_name='event',
            name='meeting_link',
            field=models.URLField(blank=True, help_text='Zoom/Teams/Meet link for online events', null=True),
        ),
        migrations.AddField(
            model_name='event',
            name='status',
        ...
        migrations.AlterField(
            model_name='event',
            name='event_type',
            field=models.CharField(choices=[('workshop', 'Workshop'), ('seminar', 'Seminar'), ('conference', 'Conference'), ('hackathon', 'Hackathon'), ('webinar', 'Webinar'), ('cultural', 'Cultural Event'), ('technical', 'Technical Event'), ('sports', 'Sports Event'), ('competition', 'Competition'), ('social', 'Social Event'), ('other', 'Other')], max_length=20),
        ),
        migrations.AlterField(
            model_name='event',
        ...
        migrations.AddField(
            model_name='eventfeedback',
            name='registration',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='feedback', to='events.eventregistration'),
        ),
        migrations.AddField(
            model_name='eventschedule',
            name='event',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='schedule', to='events.event'),
        ),
        migrations.AddField(
